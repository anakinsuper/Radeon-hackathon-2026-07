...
<section class="cover"><div class="kicker">AMD AI DEVMASTER HACKATHON 2026 · TRACK 2</div><h1>NuclidePath</h1><h2>Private agents. Deterministic physics.</h2><p>A fully local, physics-first AI workflow for traceable Cs-137 groundwater screening.</p><img src="${dashboardUrl}"><div class="stats"><div class="stat"><b>5/5</b>Track 2 capabilities</div><div class="stat"><b>231</b>AMD core snapshot</div><div class="stat"><b>356/15</b>latest PR gate</div><div class="stat"><b>0</b>cloud calls</div></div><p style="margin-top:12mm"><b>Team:</b> Physics-First AI · <b>Author:</b> Stefano Rigante</p></section>
${body}
</body></html>`;
