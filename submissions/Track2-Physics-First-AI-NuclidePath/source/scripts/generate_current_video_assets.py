...
def main():
    ...
    card(out/"slide-01.png","Track 2 · Current verified build","NuclidePath","Private agents. Deterministic physics. Current release evidence.",[("5/5","Track 2 capabilities",GREEN),("356/15","latest PR gate",BLUE),("231","AMD core snapshot",ORANGE)], ["The LLM plans only allow-listed steps; deterministic tools own every physical number."])
