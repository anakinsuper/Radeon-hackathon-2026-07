...
- [x] contest fork branch exists and is synchronized to current `main` documentation head `c1cd1f2` (code-bearing checkpoint `2b256e322eaa8ca45a5b939fdecad09d66019b0c`); complete source copied under `submissions/Track2-Physics-First-AI-NuclidePath/source/` with contest-local manifest v2.0;
